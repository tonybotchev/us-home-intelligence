      ...
      <main className="flex-1 pt-24">
        <section className="py-20 px-6">
          <div className="max-w-4xl mx-auto text-[#9ca3af] leading-relaxed space-y-8">
            ...
            <p>These Terms govern use of intel.nofluffmarketing.io, operated by NoFluff Marketing LLC, 3333 Preston Rd Ste 300 #1570, Frisco, TX 75034. NoFluff Marketing LLC, 3333 Preston Rd Ste 300 #1570, Frisco, TX 75034.</p>
            <div>
              <h2 className="text-xl font-bold text-[#f0f0f5] mb-3">USHI Reports — Not Financial Advice</h2>
              <p>USHI reports are for informational purposes only and do not constitute financial, investment, or legal advice. </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p>US Home Intelligence reports are produced exclusively by NoFluff Marketing LLC and are for informational purposes only. They do not constitute financial, investment, legal, or appraisal advice.</p>
            </div>
            <div>
