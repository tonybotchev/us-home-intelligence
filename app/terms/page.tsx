        ...
        <section className="py-20 px-6">
          <div className="max-w-4xl mx-auto text-[#9ca3af] leading-relaxed space-y-8">
            ...
            <div>
              ...
              <p>Partners must hold a valid real estate license. The Realtor Partner Program pricing is locked as of June 12, 2026 and supersedes any prior comp-credit model. Signup is free — no subscription, no monthly fee, no tiers. Each agent signs up individually. Upon signup, each partner receives one free cobranded demo report. Every subsequent report ordered by the partner is billed at the partner rate: $48.50 for a zip-level report (public price $97) or $73.50 for an address-specific report (public price $147). Partners must attest at each order that the report is for an active buyer prospect they are currently representing. All cobranded reports include DFW Homes &amp; Loans (Tony Botchev, NMLS #114198, sponsored by Loan Factory, NMLS #320841) as the preferred mortgage partner. RESPA-clean: no fees flow between NoFluff Marketing LLC and realtor partners for mortgage referrals. Buyers always decide who to use for their mortgage.</p>
            </div>
            <div>
